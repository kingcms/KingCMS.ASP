...
function king_tag_mood(tag,invalue)
	...
	if validate(commentid,"^[A-Za-z0-9\_\-]*\|\d+$") then
		I1="<script src="""&king.page&"mood/mood.js"" type=""text/javascript""></script><div id=""k_mood""><table width=""528"" border=""0"" cellpadding=""0"" cellspacing=""2"" style=""font-size:12px;margin-top: 20px;margin-bottom: 20px;"">"
